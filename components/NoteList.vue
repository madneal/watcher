<template>
    <div id="notes-list">
        ...
        <div class="btn-group btn-group-justified" role="group">
            ...
            <div class="btn-group" role="group">
                <button type="button" class="btn btn-default" @click="show = 'favorite'" :class="{active: show === 'favorites'}">Favprites</button>
            </div>
        </div>   
    </div>
    <div class="container">
        <div class="list-group">
            <a v-for="note in fliteredNotes" class="list-group-item" href="#"
